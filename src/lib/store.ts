...
export const useSearchStore = create<SearchState>((set) => ({
  ...
  setTrendData: (d: PriceTrendPoint[]) => set({ trendData: d }),
  setClarification: (opts) => set({ clarificationOptions: opts }),
  reset: () =>
    set({ results: [], cheapest: null, summary: '', insights: [], error: null, trendData: [], query: '', retailerStatuses: [], clarificationOptions: null, isLoading: false }),
}));
